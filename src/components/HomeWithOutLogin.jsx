...
import solutionImage from '../assets/the-do-nation-station-high-resolution-logo.png'; // Add your solution image here
...
const HomeWithOutLogin = () => {
  return (
    <div>
      ...
      <section className="flex flex-col items-center p-10 bg-white mt-5">
        ...
        <div className="bg-gray-100 p-10 mt-20 flex flex-col md:flex-row items-start justify-between">
      ...
      <footer className="bg-gray-100 text-center p-6 mt-auto">
        ...
        <p>For more information, contact us at <a href="mailto:pranav9176@gmail.com" className="text-blue hover:underline">pranav9176@gmail.com</a></p>
      </footer>
    </div>
  );
}
